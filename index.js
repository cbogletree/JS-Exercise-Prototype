...
const { assertRegexLiteral } = require("@babel/types");
...
/* 
  ...
  2. Window Binding other rules apply, this will return the window or global object in node or undefinded in strict mode.
  3. new binding 
  4. implicit binding 
*/
